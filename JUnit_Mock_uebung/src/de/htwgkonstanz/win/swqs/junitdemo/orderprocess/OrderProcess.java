...
public class OrderProcess {
	...
	public OrderProcess(Inventory inventory, Storage storage, AccountingSystem accountingSystem, Statistics statistics) {
	...
	public void order(ShoppingBasket shoppingBasket) {
		...
		accountingSystem.saveOrder(orderNumber, shoppingBasket.getOrderItems(),shoppingBasket.getTotalSalesPrice());
	}
}
